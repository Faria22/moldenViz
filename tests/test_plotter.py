...
def test_ui_helpers_are_defined_in_companion_module() -> None:
    ...
    assert plotter_module._OrbitalSelectionScreen.__module__ == plotter_ui_module.__name__  # noqa: SLF001
    assert plotter_module._OrbitalsTreeview.__module__ == plotter_ui_module.__name__  # noqa: SLF001
